...
<html>
	<head>
		<title>Edit Tester - BugTracker</title>
		...
		<?php
			...
			if(!empty($_POST))
			{
				...
				if(empty($errors))
				{
					...
					if(AdminActions :: editTester($tester, $pass))
					{
						echo "The tester was edited successfully!<br />";
					}
					else
					{
						echo "Cannot edit tester!<br />";
					}
				}
				else
				{
